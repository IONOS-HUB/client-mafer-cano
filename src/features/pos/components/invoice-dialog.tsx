...
import { FileText, User, CreditCard, Banknote, ArrowLeft, CheckCircle } from "lucide-react";
...
interface InvoiceDialogProps {
    ...
    onConfirmWithData: (customerData: CustomerData, paymentDetails: PaymentDetails) => void;
    total: number;
}
...
export function InvoiceDialog({
    ...
    const handleSubmitData = (values: CustomerFormValues) => {
    ...
    const quickCashOptions = [
        ...
        50,
        100
    ].filter((val, index, self) => val >= total && self.indexOf(val) === index).sort((a, b) => a - b).slice(0, 4);
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">Venta rápida sin datos</p>
                                </div>
                            </Button>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmitData)} className="space-y-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Número de ID" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            <div className="flex gap-3 pt-4">
                                <Button type="button" variant="outline" onClick={() => setStep("selection")} className="flex-1">
                ...
                {step === "payment" && (
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-3 pt-2">
                            <Button
                                variant="outline"
                                onClick={() => setStep(customerData ? "data_entry" : "selection")}
                                className="flex-1"
                            >
                                <ArrowLeft className="mr-2 h-4 w-4" /> Atrás
                            </Button>
